...
var Ambush = exports.Ambush = (function () {
	...
	Ambush.prototype.init = function () {
		...
		this.numPlayers = 0;
		this.started = false;
		Bot.say(this.room, "Se ha iniciado un juego de **Ambush**! Para inscribirse usad **/me in**. Consiste en eliminar a otros usuarios usando /me fires [usuario]. Para comenzar el juego hay que usar **.start**. El juego termina cuando solo que de uno.");
	};
...
var PassTheBomb = exports.PassTheBomb = (function () {
	function PassTheBomb (opts, output) {
		this.output = output;
		this.room = opts.room || '';
		this.title = opts.title || 'Pass-The-Bomb';
